...
struct pbRectangle;
typedef struct pbRectangle pbRectangle;
...
_Bool RectanglesOverlap(pbRectangle *r1, pbRectangle *r2);
pbRectangle *CreateRectangle(double x1, double y1, double x2, double y2);
void CopyRectangleValues(pbRectangle *rd, pbRectangle *rs);

void DrawXLabelsForPriority(double p, double xMin, double oy, double xMax, double xPixelMin, double xPixelMax, NumberReference *nextRectangle, RGBA *gridLabelColor, RGBABitmapImage *canvas, double *xGridPositions, size_t xGridPositionsLength, StringArrayReference *xLabels, NumberArrayReference *xLabelPriorities, pbRectangle **occupied, size_t occupiedLength, _Bool textOnBottom);
void DrawYLabelsForPriority(double p, double yMin, double ox, double yMax, double yPixelMin, double yPixelMax, NumberReference *nextRectangle, RGBA *gridLabelColor, RGBABitmapImage *canvas, double *yGridPositions, size_t yGridPositionsLength, StringArrayReference *yLabels, NumberArrayReference *yLabelPriorities, pbRectangle **occupied, size_t occupiedLength, _Bool textOnLeft);
...
void ComputeBoundariesBasedOnSettings(ScatterPlotSettings *settings, pbRectangle *boundaries);
...
void SetPixels(RGBABitmapImage *image, double x, double y, RGBA *color);
void DrawPixel(RGBABitmapImage *image, double x, double y, RGBA *color);
double CombineAlpha(double as, double ad);
double AlphaBlends(double cs, double as, double cd, double ad, double ao);
...
RGBABitmapImage *CopyImg(RGBABitmapImage *image);
